...
$stmt = $pdo->prepare("SELECT a.*, c.title as course_title, u.name as teacher_name FROM assignments a LEFT JOIN courses c ON a.course_id = c.id JOIN users u ON a.teacher_id = u.id ORDER BY a.created_at DESC");
$stmt->execute();
